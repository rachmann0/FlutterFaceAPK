...
public class CameraManager implements CameraPreview.CameraPreviewListener {
    ...
    public void onStartPreview() {
        Log.d("FacePassDemo", "onStartPreview: ");
        camera.setPreviewCallbackWithBuffer(new Camera.PreviewCallback() {
            @Override
            public void onPreviewFrame(byte[] data, Camera camera) {
                //Log.d("FacePassDemo", "getPreviewFormat: " +String.valueOf(camera.getParameters().getPreviewFormat()));
                //Log.d("FacePassDemo", "getPreviewSize: " +camera.getParameters().getPreviewSize());
                //Log.d("FacePassDemo", "getPreviewSize: " +camera.getParameters());
                if (listener != null) {
